...
public abstract class Megalodon extends Creature implements PeutNager{
     ...
     */
    public Megalodon(SexesEnum sexe, int poids, int taille, int age, String nom) {
        super(EspecesEnum.MEGALODON, sexe, poids, taille, age, false, false, true , nom);
    }
     ...
     * @param nom String nom de la creature (ne depend pas de son espece)
     */
    public Megalodon(SexesEnum sexe, int poids, int taille, int age, boolean faim, boolean estEnTrainDeDormir, boolean sante, String nom) {
        super(EspecesEnum.MEGALODON, sexe, poids, taille, age, faim, estEnTrainDeDormir, sante, nom);
    }
